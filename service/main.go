...
func main() {
	...
	if err != nil {
		...
		color.Warn.Println("2. 本程序生成的v2ray配置文件将占用10800(socks)、10801(http)、10802(http)端口，如果端口已被占用将会出错，如需修改端口请按照v2ray文档修改models/v2rayTmpl/v2rayTmpl.go的templateJson变量")
