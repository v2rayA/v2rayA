...
type Params struct {
	...
	TransparentPostStartHook string   `id:"transparent-post-start-hook" desc:"the executable file to run after the transparent proxy starting. v2rayA will pass in the --transparent-type argument."`
	...
	TransparentPostStopHook  string   `id:"transparent-post-stop-hook" desc:"the executable file to run after the transparent proxy stopping. v2rayA will pass in the --transparent-type argument."`
