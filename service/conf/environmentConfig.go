...
type Params struct {
	...
	TransparentPreStartHook   string   `id:"transparent-pre-start-hook" desc:"the executable file to run before the transparent proxy starting"`
	TransparentAfterStartHook string   `id:"transparent-after-start-hook" desc:"the executable file to run after the transparent proxy starting"`
	TransparentPreStopHook   string   `id:"transparent-pre-stop-hook" desc:"the executable file to run before the transparent proxy stopping"`
	TransparentAfterStopHook string   `id:"transparent-after-stop-hook" desc:"the executable file to run after the transparent proxy stopping"`
