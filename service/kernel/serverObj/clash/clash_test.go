...
proxies:
  ...
  - name: tr1
    ...
    ws-opts:
      ...
      headers:
        Host: h.example.com
  - {name: vl1, type: vless, server: v.example.com, port: 443, uuid: 8f6d1a3b-0000-4000-8000-000000000001, network: tcp, tls: true, servername: v.example.com, flow: xtls-rprx-vision, client-fingerprint: chrome, reality-opts: {public-key: pbk, short-id: abcd}}
  - {name: vm1, type: vmess, server: m.example.com, port: 80, uuid: 8f6d1a3b-0000-4000-8000-000000000002, alterId: 0, cipher: auto, network: ws, ws-opts: {path: /vm, headers: {Host: m.example.com}}}
