...
import (
	...
	"github.com/v2rayA/v2rayA/pkg/plugin/infra/socks"
...
func NewSocks5(s string, d infra.Dialer, p infra.Proxy) (*Socks5, error) {
	u, err := url.Parse(s)
	if err != nil {
...
func NewSocks5Dialer(s string, d infra.Dialer) (infra.Dialer, error) {
	return NewSocks5(s, d, nil)
}

// NewSocks5Server returns a socks5 proxy server.
func NewSocks5Server(s string, p infra.Proxy) (infra.Server, error) {
