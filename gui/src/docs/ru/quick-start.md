...
### Всегда использовать первый сервер

Выключено: выбирать рабочий сервер, сохраняя балансировку группы. Включено: следовать первой записи, даже если она недоступна.

Автоматически восстанавливать соединение: После минуты сбоев обновлять подписку и повторять попытки. По умолчанию выключено; учитывает ручную остановку.
