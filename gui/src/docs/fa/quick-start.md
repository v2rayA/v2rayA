...
در صورت خطا یا دریافت پاسخ خالی، فهرست ذخیره‌شدهٔ سرورها حفظ می‌شود. تلاش‌های بازیابی برنامهٔ منظم را عقب نمی‌اندازند و یک بررسی طولانی با بررسی بعدی هم‌پوشانی ندارد. در Linux دریافت بازیابی از اتصال علامت‌گذاری‌شده استفاده می‌کند تا پراکسی شفاف آن را دوباره وارد پراکسی خراب نکند. این دور زدن برای حالت TUN در macOS یا Windows تضمین نمی‌شود. بررسی سرورها ممکن است فرایندهای موقت هسته را اجرا کند، اما هستهٔ اصلی که کاربر متوقف کرده است به‌صورت خودکار شروع نمی‌شود.
