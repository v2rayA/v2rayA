export default {
  ...
  subscription: {
    alwaysFirst: "همیشه از اولین سرور استفاده شود",
    selectionHelp:
      "خاموش: سرور سالم انتخاب می‌شود و توازن گروه حفظ می‌شود. روشن: اولین مورد حتی در صورت قطع بودن انتخاب می‌شود.",
    monitor: "بازیابی خودکار اتصال ناموفق",
    monitorHelp:
      "پس از یک دقیقه خطا، اشتراک به‌روز و تلاش تکرار می‌شود. پیش‌فرض خاموش است و توقف دستی را رعایت می‌کند.",
