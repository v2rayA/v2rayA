export default {
  ...
  subscription: {
    autoUpdate: "به‌روزرسانی خودکار اشتراک",
    autoUpdateHelp:
      "فقط فهرست سرورها به‌روز می‌شود. افزودن خودکار اعضا را در گروه پراکسی تنظیم کنید.",
    updateIntervalMinutes: "به‌روزرسانی منظم (دقیقه)",
    regularHelp: "الزامی است. صفر به‌روزرسانی منظم را غیرفعال می‌کند.",
    failureIntervalMinutes: "تلاش پس از خطا (دقیقه)",
    failureHelp: "الزامی، حداقل ۱ دقیقه. وقتی همهٔ سرورها قطع هستند به‌روز می‌کند؛ با اتصال یک سرور تکرار متوقف می‌شود.",
  ...
  outbound: {
    ...
    autoAddHelp: "سرورهای در دسترس را از تمام فهرست پراکسی، شامل همهٔ اشتراک‌ها، در گروه نگه می‌دارد.",
    autoAddDetails: "پس از تغییر فهرست و در هر دورهٔ بررسی اجرا می‌شود. اعضای قطع‌شده حذف می‌شوند. گروه خالی ترافیک خود را مسدود می‌کند.",
