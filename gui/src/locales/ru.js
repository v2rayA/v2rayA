export default {
  ...
  subscription: {
    ...
    filterPattern: "Шаблон фильтра",
    filterPatternHint: "Оставить только серверы, имена которых соответствуют этому регулярному выражению. Оставьте пустым, чтобы отключить фильтрацию.",
  },
  operations: {
    name: "Операции",
    update: "Обновить",
