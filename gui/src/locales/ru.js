export default {
  ...
  subscription: {
    alwaysFirst: "Всегда использовать первый сервер",
    selectionHelp:
      "Выключено: выбирать рабочий сервер, сохраняя балансировку группы. Включено: следовать первой записи, даже если она недоступна.",
    monitor: "Автоматически восстанавливать соединение",
    monitorHelp:
      "После минуты сбоев обновлять подписку и повторять попытки. По умолчанию выключено; учитывает ручную остановку.",
